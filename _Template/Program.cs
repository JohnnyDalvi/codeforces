...
{    static void Solve(FastReader reader, StreamWriter writer)
    {
        ...
        for (int i = 0; i < a; i++)
        {
            ...
            PrintWordNum(word, writer);
        }


    }

    static void PrintWordNum(string word, StreamWriter writer)
    {
        if (word.Length <= 10)
        {
        ...
        string shortenedWord = $"{word[0]}{word.Length - 2}{word[^1]}";
        writer.WriteLine(shortenedWord);
